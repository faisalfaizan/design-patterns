...
public class SalesPerson implements Client, Observer{

	Log log = LogFactory.getLog(SalesPerson.class);
	...
	public SalesPerson(Observable observable){
	...
	public void update(Observable observable) {
		...
		if(BUY.equalsIgnoreCase(rating)){
			log.info("Advice Investor to accumulate shares of " + securityName);
		}
